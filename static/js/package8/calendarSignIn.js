$(function() {
    ...
    $.ajax({
    	...
    	success:function(data){
		    ...
		    $dateLi.eq( monthFirst+myDate.getDate()-1 ).find('div').css({background:"none",border:"1px solid #FF8823","display":"block"});
		    $dateLi.eq( monthFirst+myDate.getDate()-1 ).find("span").css("color","#FF8823");
    	}
    });
